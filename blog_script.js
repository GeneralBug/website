/*Modified from Zonelet Starter by Marina Kittaka
...
let blogName = "Bug's Blog";
let authorName = "GeneralBug";
...
let postsArray = 
[
  [ "posts/2025-04-15-The-First-One.html"],
  [ "posts/2026-01-26-Blogger-I-Hardly-Know-Her.html", encodeURI("Blogger? I Hardly Know Her!") ]
];

postsArray.sort().reverse()
...
if ( currentIndex > -1 ) {
  ...
  if (  postDateFormat.test ( postsArray[currentIndex][0].slice( 6,17 ) ) ) {
	...
	niceDate = postsArray[currentIndex][0].slice( 14,16 ) + "/" + postsArray[currentIndex][0].slice( 11,13 ) + "/" + postsArray[currentIndex][0].slice( 6,10 );
  }
}
...
{
  postListHTML = '<a href=\"notes.html\">Game Notes! (not reviews)</a><hr>Blog Posts! (also not reviews)<button class="small_sort_button" onclick="reversePostList()">\u21F5</button><ul>';
  ...
  recentPostListHTML = "<h2>Recent Posts:</h2><ul>";
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a class= "link_button" id="icon_home" href="' + relativePath + '/blog.html"><img class="link_icon_gif"  src="' + relativePath + '/Assets/Gifs/navigation/icon_home.png" alt="Home"><p class="link_button_text">Home</p></a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a class= "link_button" id="icon_back" href="' + relativePath + '/' + prevlink + '"><img class="link_icon_gif"  src="' + relativePath + '/Assets/Gifs/navigation/icon_back.png" alt="Backward"><p class="link_button_text">Prev.</p></a><a class= "link_button" id="icon_home" href="' + relativePath + '/blog.html"><img class="link_icon_gif"  src="' + relativePath + '/Assets/Gifs/navigation/icon_home.png" alt="Home"><p class="link_button_text">Home</p></a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a class= "link_button" id="icon_home" href="' + relativePath + '/blog.html"><img class="link_icon_gif"  src="' + relativePath + '/Assets/Gifs/navigation/icon_home.png" alt="Home"><p class="link_button_text">Home</p></a><a class= "link_button" id="icon_forward" href="' + relativePath + '/' + nextlink + '"><img class="link_icon_gif"  src="' + relativePath + '/Assets/Gifs/navigation/icon_forward.png" alt="Forward"><p class="link_button_text">Next</p></a>';
